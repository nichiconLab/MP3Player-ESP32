...
static const uint8_t PROGMEM initcmd[] = {
  ...
  //ILI9341_PWCTR1  , 1, 0x07,             // Power control VRH[5:0]  3.2V
  ILI9341_PWCTR2  , 1, 0x10,             // Power control SAP[2:0];BT[3:0]
  ILI9341_VMCTR1  , 2, 0x3e, 0x28,       // VCM control  VCOMH=0x3e=4.250V, VCOML=0x28=-1.500V, |VCOMH-VCOML|=5.750V
  //ILI9341_VMCTR1  , 2, 0x30, 0x28,       // VCM control  VCOMH=0x30=3.900V, VCOML=0x28=-1.500V, |VCOMH-VCOML|=5.400V < 5.5V
