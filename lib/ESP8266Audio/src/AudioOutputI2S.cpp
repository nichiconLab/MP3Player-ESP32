...
bool AudioOutputI2S::SetPinout()
{
    ...
    i2s_pin_config_t pins = {
        .mck_io_num = I2S_PIN_NO_CHANGE, //0, // Unused  //<-
        .bck_io_num = bclkPin,
        .ws_io_num = wclkPin,
...
bool AudioOutputI2S::begin(bool txDAC)
{
    ...
    if (!i2sOn)
    {
      ...
      i2s_config_t i2s_config_dac = {
          .mode = mode,
          .sample_rate = 44100,  //44100->96000
          .bits_per_sample = I2S_BITS_PER_SAMPLE_16BIT,
          .channel_format = I2S_CHANNEL_FMT_RIGHT_LEFT,
          .communication_format = comm_fmt,
          .intr_alloc_flags = ESP_INTR_FLAG_LEVEL1, // lowest interrupt priority
          .dma_buf_count = dma_buf_count,
          .dma_buf_len = 128,  //128->1024
          .use_apll = use_apll, //use_apll, // Use audio PLL
          .tx_desc_auto_clear = true, // Silence on underflow //true->false
          .fixed_mclk = 0, // Unused  //0->4
          .mclk_multiple = I2S_MCLK_MULTIPLE_DEFAULT, //I2S_MCLK_MULTIPLE_DEFAULT, // Unused
